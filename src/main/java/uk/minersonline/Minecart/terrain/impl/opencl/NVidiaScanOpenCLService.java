...
public final class NVidiaScanOpenCLService {
    ...
    BufferGpu d_Buffer;
    CLKernel ckScanExclusiveLocal1, ckScanExclusiveLocal2, ckUniformUpdate;
    ...
    public int[] getIntBuffer(BufferGpu buffer, int size){
        IntBuffer resultBuff = BufferUtils.createIntBuffer(size);
        CL10.clEnqueueReadBuffer(ctx.getClQueue(), buffer.getMem(), 1, 0, resultBuff, null, null);
    ...
    void scanExclusiveLocal1(BufferGpu d_Dst, BufferGpu d_Src, int n, int size){
        clSetKernelArg(ckScanExclusiveLocal1, 0, d_Dst.getMem());
        clSetKernelArg(ckScanExclusiveLocal1, 1, d_Src.getMem());
        clSetKernelArg(ckScanExclusiveLocal1, 2, 2 * WORKGROUP_SIZE * 4);
        clSetKernelArg(ckScanExclusiveLocal1, 3, size);
    ...
    void scanExclusiveLocal2(BufferGpu d_Buffer, BufferGpu d_Dst, BufferGpu d_Src, int n, int size){
        int elements = n * size;
        clSetKernelArg(ckScanExclusiveLocal2, 0, d_Buffer.getMem());
        clSetKernelArg(ckScanExclusiveLocal2, 1, d_Dst.getMem());
        clSetKernelArg(ckScanExclusiveLocal2, 2, d_Src.getMem());
        clSetKernelArg(ckScanExclusiveLocal2, 3, 2 * WORKGROUP_SIZE * 4);
        clSetKernelArg(ckScanExclusiveLocal2, 4, elements);
        clSetKernelArg(ckScanExclusiveLocal2, 5, size);
    ...
    void uniformUpdate(BufferGpu d_Dst, BufferGpu d_Buffer, int n){
        clSetKernelArg(ckUniformUpdate, 0, d_Dst.getMem());
        clSetKernelArg(ckUniformUpdate, 1, d_Buffer.getMem());
