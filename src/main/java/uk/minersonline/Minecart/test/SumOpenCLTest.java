...
public final class SumOpenCLTest {
    ...
    public void run() {
        ...
        int errcode = clBuildProgram(sumProgram, ctx.getClDevice(), "", null);
        ...
        clSetKernelArg(clKernel, 0, aMemory.getMem());
        clSetKernelArg(clKernel, 1, bMemory.getMem());
        clSetKernelArg(clKernel, 2, resultMemory.getMem());
    ...
    private void printResults() {
        ...
        CL10.clEnqueueReadBuffer(ctx.getClQueue(), resultMemory.getMem(), 1, 0, resultBuff, null, null);
